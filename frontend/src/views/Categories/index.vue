...
import { getCategoriesTree, createCategory, updateCategory, deleteCategory as deleteCategoryApi } from '@/api/categories'
...
const loadCategories = async () => {
  loading.value = true
  try {
    categories.value = await getCategoriesTree()
  } catch (error) {
...
const showCreateDialog = (parent?: Category) => {
